...
save_dir="/data/share/project/psjin/data/generated_data/${task_type}/generation_results/test_augmentation"
mkdir -p "${save_dir}"
OVERWRITE=1
...
for language in "${languages[@]}"; do
    ...
    cmd="python /data/share/project/psjin/code/data_generation/code_for_AILAStatutes/data_augmentation/run_generation.py \
        --task_type ${task_type} \
        --save_dir ${save_dir} \
