...
def get_generation_prompt(
    ...
    task_to_gen_instruction: Dict[TaskType, str] = {
        ...
        TaskType.covidretrieval: "Given a news article related to COVID-19 in {language}, generate a question in {language} that the article can answer."
        # Given a document in Chinese, generate a quality score (1-5) indicating how well the document is related to Covid-19 news.
    }
