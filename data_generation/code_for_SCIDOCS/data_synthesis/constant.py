...
def get_generation_prompt(
    ...
    task_to_gen_instruction: Dict[TaskType, str] = {
        ...
        TaskType.scidocs: "Given a scientific paper abstract in {language}, generate a scientific paper title in {language} that would likely cite this paper as a reference.",
    }
