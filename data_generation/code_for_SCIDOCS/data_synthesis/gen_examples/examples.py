...
SCIDOCS_TRAIN_ROOT = "/share/project/shared_datasets/mteb/datasets--mteb--scidocs/snapshots/f8c2fcf00f625baaa80f62ec5bd9e1fff3b8ae88"
NUM_SAMPLES = 10


def load_scidocs_train(language: str):
    #file_path = os.path.join(SCIDOCS_TRAIN_ROOT, f"scidocs_{language}.jsonl")
    corpus_path = os.path.join(SCIDOCS_TRAIN_ROOT, "corpus.jsonl")
    query_path = os.path.join(SCIDOCS_TRAIN_ROOT, "queries.jsonl")
    qrels_path = os.path.join(SCIDOCS_TRAIN_ROOT, "qrels/test.jsonl")
...
def main():
    ...
    save_dir = "/share/project/psjin/dataset/examples/scidocs"
    os.makedirs(save_dir, exist_ok=True)
    
    for language in language_list:
        data_list = load_scidocs_train(language)
