...
corpus_dir="/share/project/shared_datasets/mteb/datasets--mteb--scidocs/snapshots/f8c2fcf00f625baaa80f62ec5bd9e1fff3b8ae88"
...
query_instruction_for_retrieval="Given a scientific paper title, retrieve paper abstracts that are cited by the given paper."
...
for language in "${languages[@]}"; do
    ...
    python /share/project/psjin/code/code_for_SCIDOCS/hn_mine/mine_v2_modified.py \
