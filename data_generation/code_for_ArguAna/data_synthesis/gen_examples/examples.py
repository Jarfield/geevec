...
ArguAna_TRAIN_ROOT = "shared_models/datasets--mteb--arguana/snapshots/c22ab2a51041ffd869aaddef7af8d8215647e41a"
NUM_SAMPLES = 10


def load_ailastatutes_train(language: str):
    #file_path = os.path.join(ArguAna_TRAIN_ROOT, f"ailastatutes_{language}.jsonl")
    corpus_path = os.path.join(ArguAna_TRAIN_ROOT, "corpus.jsonl")
    query_path = os.path.join(ArguAna_TRAIN_ROOT, "queries.jsonl")
    qrels_path = os.path.join(ArguAna_TRAIN_ROOT, "qrels/test.jsonl")
...
def main():
    ...
    save_dir = "/share/project/psjin/dataset/examples/arguana"
