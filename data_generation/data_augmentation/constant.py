...
class TaskType(Enum):
    ...
    scidocs = "Given a scientific document, retrieve papers that discuss the same topic."
    # ArguAna: argumentative passage retrieval
    arguana = "Given a claim, retrieve passages that argue for or against it."
...
def get_generation_prompt(
    ...
    task_to_gen_instruction: Dict[TaskType, str] = {
        ...
        TaskType.scidocs: (
            "Given a scientific abstract in {language}, generate a research question or paper title "
            "in {language} that this abstract could answer or relate to."
        ),
        TaskType.arguana: (
            "Given an argumentative passage in {language}, generate a sharp claim or question in {language} "
            "that someone might search for to find this passage."
        ),
    }
    ...
    task_to_gen_output: Dict[TaskType, str] = {
        ...
        TaskType.scidocs: "the generated research question in {language}",
    ...
    # ===== ⭐ CovidRetrieval / AILA 专用的 focus 提示 =====
    focus_hint = ""
    ...
    elif task.task_type is TaskType.ailastatutes and narrative_focus is not None:
        focus_hint = f"\n\nPlease describe the situation with a narrative focus on: {narrative_focus}."
