...
CACHE_DIR="${CACHE_DIR:-}"  # optional LLM cache for scoring

# 输入/输出路径需根据实际数据目录填写
INPUT_PATH="${INPUT_PATH:-$REPO_ROOT/data/exported_original/$TASK_TYPE/en/$TASK_TYPE/hn_mine_data/en_original.jsonl}"
OUTPUT_PATH="${OUTPUT_PATH:-$REPO_ROOT/data/exported_original/$TASK_TYPE/en/$TASK_TYPE/hn_mine_data/en_original_scored.jsonl}"
